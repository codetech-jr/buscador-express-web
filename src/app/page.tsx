      ...
      <section className="hero-section relative overflow-hidden">
        ...
        <div className="container hero-container relative z-10">
          ...
          <div className="hero-content-left">
            <div className="brand-badge animate-fade-up">
              <span className="brand-icon">⚡</span>
              <span className="brand-label">Disponibilidad Inmediata · Charallave</span>
            </div>

            <h1 className="hero-title animate-fade-up staggered-1">
              Encuentra el repuesto exacto para tu moto en{' '}
              <span className="hero-title-accent">Segundos</span>
            </h1>

            <p className="hero-subtitle animate-fade-up staggered-2">
              El catálogo más completo de Valles del Tuy. Consulta precios en Bs y USD en tiempo real, verifica disponibilidad y pide por WhatsApp sin salir de casa.
            </p>

            <div className="hero-actions animate-fade-up staggered-3">
              <a href="#buscador" className="hero-cta-primary">
                Buscar Repuesto
              </a>
              <a
                href={whatsappHref}
            ...
            {/* Proof Stats */}
            <div className="hero-stats animate-fade-up staggered-4">
              ...
              <div className="stat-item">
                ...
                <span className="stat-label">Catálogo Online</span>
              </div>
              <div className="stat-divider" />
              <div className="stat-item">
                <span className="stat-value">45 min</span>
                <span className="stat-label">Delivery Express</span>
              </div>
            </div>
          </div>

          {/* Right Content - Visual */}
          <div className="hero-content-right animate-fade-in staggered-2">
            <div className="hero-image-wrapper">
              <div className="hero-image-inner">
                <Image
                  src="https://placehold.co/600x700/0f1420/25D366?text=Moto+Parts+Visual"
                  alt="Repuestos de motos premium"
                  width={600}
                  height={700}
